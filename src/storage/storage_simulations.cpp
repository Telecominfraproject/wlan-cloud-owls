...
template <>
void ORM::DB<OpenWifi::SimulationDBRecordType, OpenWifi::OWLSObjects::SimulationDetails>::Convert(
	const OpenWifi::SimulationDBRecordType &In, OpenWifi::OWLSObjects::SimulationDetails &Out) {
	Out.id = In.get<0>();
	Out.name = In.get<1>();
...
template <>
void ORM::DB<OpenWifi::SimulationDBRecordType, OpenWifi::OWLSObjects::SimulationDetails>::Convert(
	const OpenWifi::OWLSObjects::SimulationDetails &In, OpenWifi::SimulationDBRecordType &Out) {
	Out.set<0>(In.id);
	Out.set<1>(In.name);
