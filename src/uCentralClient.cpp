...
void uCentralClient::run()
{
    std::cout << "Starting serial " << SerialNumber_ << std::endl;
}

std::string uCentralClient::DefaultCapabilities() const {

    return std::string("");
}

std::string uCentralClient::DefaultConfiguration() const {
    return std::string{
